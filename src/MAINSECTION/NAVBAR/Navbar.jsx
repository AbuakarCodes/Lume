...
function Navbar({ toggleSidebar, isSidebarOpen }) {
  return (
    <div className=" flex items-center justify-between w-full lg:py-4  px-2">
      <div className="flex items-center gap-x-2">
        <button
          onClick={toggleSidebar}
          className={` hover:bg-[#E2E7EB] lg:hidden dark:hover:bg-[#353739] transition-all duration-100 p-[.48rem] rounded-[50%] w-auto`}
        >
          <IoMenuSharp />
        </button>
